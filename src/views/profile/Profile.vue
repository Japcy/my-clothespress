...
export default {
  ...
  data: function() {
    return {
      orderList: [
        { icon: "/profileicon/email.svg", info: "我的消息" },
        { icon: "/profileicon/rmb.svg", info: "积分商城" },
        { icon: "/profileicon/vip.svg", info: "会员卡" }
      ],
      serviceList: [
        { icon: "/profileicon/cart-full.svg", info: "我的购物车" },
        { icon: "/profileicon/download.svg", info: "下载APP" }
      ]
    };
  },
  mounted: function() {}
